	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == BackButton){
			...
			if(PMR.isCanceled() == false){
				FirstGUI.PRC.addRecord(PMR.getName(), PMR.getProviderNumber(), PMR.getZipCode(), PMR.getAddress(), PMR.getCity(), PMR.getState());
		    ...
		    try {
			    ...
			    if (PMR.isCanceled() == false){
			        FirstGUI.PRC.editRecord(index,PMR.getName(), PMR.getProviderNumber(), PMR.getZipCode(), PMR.getAddress(), PMR.getCity(), PMR.getState());
