...
/**
 * Populate record collections with test data. Allows for making the various
 * reports, swiping a member's card, or editing a record.
 * 
...
public class MainGUI {
	 ...
	 * EventQueue.invokeLater(new Runnable() { public void run() { try { for(int
	 * i = 0; i < 20; i++){ FirstGUI.PDC.addRecord(i, "Something Important", i *
	 * 5); } MainGUI window = new MainGUI(); window.MainMenu.setVisible(true); }
