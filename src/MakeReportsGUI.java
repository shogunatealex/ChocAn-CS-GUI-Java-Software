...
/**
 * Selection for creating member report, provider report, EFT report, or summary
 * report, or create all reports with run main accounting procedure.
 * 
 * @author David Glenn
 *
 */
public class MakeReportsGUI extends JFrame implements ActionListener {
	 ...
	 * 
	 * @param args / public static void main(String[] args) { MakeReportsGUI
	 * makeReportsScreen = new MakeReportsGUI();
